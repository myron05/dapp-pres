...
import SEL from 'assets/digiland.jpg';
...
export default function Home() {
  ...
  const EstimateSEL = (amount) => {
    ...
    if (slippage === '10') {
      return (amount * selectedTokenPrice) / 0.000027;
    }
    if (slippage === '20') {
  ...
  return (
    <Container>
      ...
      >
        <div>
          ...
          <Row align="middle" justify="space-between">
            ...
            <Col span={12}>
              <Text>: Buying in this presale assures you 50% of profit</Text>
            </Col>
          </Row>
          <br />
      ...
      <br />
      <center>
        <p className="home-title">Digiland DIGL</p>
            ...
            {priceLoading ? (
              ...
              <Row justify="space-between" align="middle">
                ...
                <div style={{ width: '35%', display: 'inline' }}>
                  ...
                  <span style={{ color: '#fff', marginLeft: '10px' }}>DIGL</span>
                </div>
              </Row>
            )}
          </FormItem>
          <Row justify="end" style={{ paddingBottom: '20px' }}>
            <Text>Profit {slippage}%</Text>
            <Button
      ...
      <p style={{wordBreak: 'break-word'}}>
        ...
        3. Make sure you have funds available in bnb. <br />
        4. Enter the contribution amount in BNB. <br />
        5. Press Contribute. <br />
        <br />
        OFFICIAL DIGILAND-TESTNET TOKEN ADDRESS :
        0xFD42b40561b9d7F5A5D28ADc6df45ABd6ea7923e
      </p>
    </Container>
  );
}